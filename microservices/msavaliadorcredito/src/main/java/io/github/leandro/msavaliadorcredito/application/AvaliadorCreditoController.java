...
import io.github.leandro.msavaliadorcredito.domain.model.DadosAvaliacao;
...
public class AvaliadorCreditoController {
    ...
    @PostMapping
    public ResponseEntity fazerAvaliacao(@RequestBody DadosAvaliacao dados){
         try {
    ...
    public ResponseEntity solicitarCartao(@RequestBody DadosSolicitacaoEmissaoCartao dados){
        try {
            ProtocoloSolicitacaoCartao protocoloSolicitacaoCartao = avaliadorCreditoService.solicitacaoEmissaoCartao(dados);
